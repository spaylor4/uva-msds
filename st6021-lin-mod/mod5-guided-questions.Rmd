...
I would choose to use height because it has the highest correlation with hipcenter (above).
...
The reduced model does not satisfy the assumption of independence of error terms, as evidenced by the lag 11 bar above exceeding the significance band.
